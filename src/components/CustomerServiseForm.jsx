  ...
  const [showFields, setShowFields] = useState({
    ...
    });  const togglePassword = (field, event) => {
    ...
    const DoctorSchema = Yup.object().shape({
      ...
      password: Yup.string()
        ...
        .matches(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/, t("password_requirements")),
              ...
              <div className="lg:flex w-full justify-center">
                <div className="px-3 my-6 md:mb-0 w-full relative">
                  <label
                    ...
                    htmlFor="password"
                  >
                   {mode === "update" ? "" : <span className="text-red-500">*</span>}
                     {t("password")}
                  </label>
                  <Field
                ...
                <div className="px-3 my-6 md:mb-0 w-full relative">
                  ...
                  <button
                    type="button"
                   onClick={(e) => togglePassword("password_confirmation", e)}
                    className="absolute  top-1/2 end-5 transform translate-y-1/2 text-gray-500 text-xl"
                  >
                    {showFields.password_confirmation ? <FaEyeSlash /> : <FaEye />}
                  </button>
                  <ErrorMessage
                    name="password_confirmation"
                    component="div"
