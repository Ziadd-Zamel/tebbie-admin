...
import AddHospitalCommissionDialog from "./AddHospitalCommissionDialog";

const HospitalCommissionTable = ({
  currentStates,
  isLoading,
  commissionData,
}) => {
  ...
  const exportToExcel = () => {
    ...
    utils.book_append_sheet(workbook, worksheet, "Hospital Commissions");
    writeFile(workbook, "Hospital_Commissions_Report.xlsx");
  };
...
export default HospitalCommissionTable;
