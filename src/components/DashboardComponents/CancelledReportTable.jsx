                          ...
                          {booking.bookings.map((book, index) => (
                            ...
                            >
                              <div className="flex items-center justify-end">
                                <span className="text-sm bg-gradient-to-bl from-[#33A9C7] to-[#3AAB95] p-1 text-white rounded-xl font-semibold">
                                  {formatDateTime(book.created_at)}
                                </span>
                              </div>
                              <p className="mt-2 text-gray-700 font-bold text-xl">
