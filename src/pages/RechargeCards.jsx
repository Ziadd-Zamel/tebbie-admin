    ...
    <section dir={direction} className="container mx-auto lg:p-6 p-4 w-full">
      <div className="flex justify-end md:flex-row flex-col gap-2 items-center">
        ...
        <button
          ...
          className="px-6 py-2 border-[#048c87]  text-[#048c87]  text-lg rounded-[8px] hover:bg-[#048c87] hover:text-white transition-all duration-500 flex justify-center items-center gap-2"
        >
          {t("Excel-Export")}
          <FaFileExcel />
        </button>
