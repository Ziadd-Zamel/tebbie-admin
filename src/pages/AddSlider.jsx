...
import { addSlider, getDoctors, getHospitals, getLabs, getXrays } from "../utlis/https";
...
const AddSlider = () => {
  ...
  const { mutate: handleAddSlider, isLoading } = useMutation({
  ...
  return (
    <div className="container mx-auto py-8">
        ...
        <div className="mb-4">
          <div className="flex justify-center items-center my-6">
            <div className="relative">
              {imagePreview ? (
                <img src={imagePreview} alt="Slider Preview" className="w-32 h-32 rounded-full object-cover" />
              ) : (
      ...
      <button
          type="submit"
          disabled={isLoading}
          className=" bg-primary hover:bg-[#048c87] w-60 text-white text-lg py-4 rounded-[8px] focus:outline-none my-4"
        >
