...
| 74  | restoreXRayTypes              | استرجاع نوع أشعة               | Restore X-Ray Type             |
...
- restoreRecharge, exportRechargeCard
...
| UserDetails            | `/dashboard/v1/get-user-report-data/{userId}`     | GET    | User details             | ✅ Implemented |
